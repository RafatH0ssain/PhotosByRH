  ...
  return (
    <div className="max-w-7xl mx-auto px-6 pb-24">
      ...
      <div className="relative z-10 pt-8 mb-10">
        ...
        >
          Professional photography for events, headshots, and company culture. Polished,
          high-quality images that reflect the professionalism and energy of your team.
        </motion.p>
      </div>
